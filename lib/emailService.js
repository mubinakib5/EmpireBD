                  ...
                  <div class="item" style="display: flex; align-items: flex-start; gap: 15px; padding: 15px 0; border-bottom: 1px solid #eee;">
                    ${item.productImage ? `
                      <div style="flex-shrink: 0; width: 80px;">
                        <img src="${item.productImage.replace(/,$/, '')}" alt="${item.productName || 'Product'}" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px; border: 1px solid #ddd; display: block;">
                      </div>
                    ` : ''}
