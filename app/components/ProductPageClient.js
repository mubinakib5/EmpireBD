        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div className="flex items-center">
              ...
              {product.navigationMenu ? (
                <Link href={`/explore/${product.navigationMenu.slug.current}`} className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">
                  {product.navigationMenu.title}
                </Link>
              ) : product.heroSegment ? (
                <Link href={`/explore/${product.heroSegment.slug.current}`} className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">
                  {product.heroSegment.title}
                </Link>
              ) : (
                <Link href="/explore" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">
                  Products
                </Link>
              )}
            </div>
