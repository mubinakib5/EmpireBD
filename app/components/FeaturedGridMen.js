...
export default function FeaturedGridMen() {
  return (
        ...
        {features.map((feature, idx) => (
          ...
          >
            <img
              ...
              draggable="false"
            />
            <div className="absolute top-0 left-0 p-6 md:p-8 z-10 text-black max-w-[320px]">
              ...
              <button className="text-xs font-semibold tracking-widest border-b-2 border-black pb-1 uppercase bg-transparent hover:opacity-80 transition">
                {feature.button}
              </button>
            </div>
